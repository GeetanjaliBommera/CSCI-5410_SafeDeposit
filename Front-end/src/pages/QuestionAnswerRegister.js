  ...
  const QAFun = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://us-central1-serverless-project-grp-4.cloudfunctions.net/SafeDepositQA",
        {
          email: email,
          answer1: answer1,
          answer2: answer2,
...
export default QuestionAnswerRegister;
